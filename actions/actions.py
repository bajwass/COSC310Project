...
class ActionWikipedia(Action): 
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        recentSearch = next(tracker.get_latest_entity_values("wikisearch"),
                               None)  
        ...
        try:
            ...
            dispatcher.utter_message(text = "Sorry, I could not find the topic on Wikipedia, try another topic")
